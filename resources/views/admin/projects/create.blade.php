    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input type="url" class="form-control bg-dark text-light" id="image" name="image">
    ...
    <div class="row">
        <div class="col">
            <div class="mb-3">
                ...
                <textarea class="form-control bg-dark text-light" id="content" name="content" rows="30" required></textarea>
            </div>
        </div>
    </div>      
</div>
